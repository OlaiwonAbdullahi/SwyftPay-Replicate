    ...
    <div className="flex flex-col md:flex-row w-auto h-auto">
      <div className=" text-center md:text-left basis-1/3 justify-center mt-4 md:ml-28">
        <div className="flex gap-2 bg-violet-200 rounded-2xl h-8 w-52 pt-1 mx-auto md:mx-1 mb-5 mt-7 md:mt-36">
          <span className="bg-violet-500 text-white rounded-xl font-inter ml-2 h-6 text-sm w-10">
            NEW
          </span>
        ...
        <p className=" font-inter text-center md:text-left mt-3 text-gray-600">
          Make swift payments in any currency with multiple payment options.
          Gain financial freedom
        </p>

        <div className=" mt-3 flex md:gap-3 gap-1">
          <button className="p-2 rounded-md border-2 border-black w-48 h-14 flex gap-3 mx-auto md:mx-0 justify-center">
            <img src={Apple}></img> <span className="mt-1">Get on iPhone</span>
          </button>
          <button className="p-2 rounded-md border-2 border-black w-48 h-14 flex gap-3 mx-auto md:mx-0 justify-center">
            <img src={Play}></img> <span className="mt-1">Get on iPhone</span>
          </button>
        </div>
      </div>
